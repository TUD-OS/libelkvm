 ...
 */
int elkvm_handle_syscall(Elkvm::VM &, struct kvm_vcpu *);
int elkvm_handle_interrupt(Elkvm::VM &, struct kvm_vcpu *);
int elkvm_handle_hypercall(Elkvm::VM &, std::shared_ptr<struct kvm_vcpu>);
